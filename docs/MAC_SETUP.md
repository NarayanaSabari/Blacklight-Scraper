...
A residential Mac sidesteps the LinkedIn and Indeed constraints: it's headed,
display-attached, and has a residential IP that the platforms trust. Glassdoor's
primary API path does not require a headed browser. Apple Silicon (M1/M2/M3)
or Intel both work; CloakBrowser provisions the required Chromium on first launch.
